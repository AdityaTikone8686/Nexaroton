...
export const PLANS = [
  { id: "stone", name: "Stone", price: 4.99, color: "#8a8a86", ram: "2 GB", slots: "10 players", backups: "Daily", support: "Community" },
  { id: "iron", name: "Iron", price: 9.99, color: "#d8d3c4", ram: "4 GB", slots: "25 players", backups: "Every 12h", support: "Email" },
  { id: "diamond", name: "Diamond", price: 19.99, color: "#4fd8e0", ram: "8 GB", slots: "60 players", backups: "Every 6h", support: "Priority chat", featured: true },
  { id: "netherite", name: "Netherite", price: 34.99, color: "#4a3b3b", ram: "16 GB", slots: "Unlimited*", backups: "Hourly", support: "Dedicated" }
];
